  ...
  nitro: {
    ...
    prerender: {
      ...
      routes: [
        ...
        // Novos perfumes árabes
        '/catalogo/lattafa-asad-100ml',
        '/catalogo/lattafa-yara-moi-100ml',
        '/catalogo/lattafa-khamrah-100ml',
        '/catalogo/al-haramain-amber-oud-gold-60ml',
        '/catalogo/al-haramain-laventure-100ml',
        '/catalogo/rasasi-hawas-100ml',
        '/catalogo/lattafa-oud-mood-100ml',
        '/catalogo/ard-al-zaafaran-dirham-100ml',
        '/catalogo/swiss-arabian-shaghaf-oud-75ml',
      ],
    },
  },
